...
FACTORIAL = Z_COMBINATOR(lambda me: lambda num: IS_ZERO(num)(lambda _: ONE)(lambda _: MULTIPLY(num)(me(DEC(num))))(NONE))
DIVIDE = Z_COMBINATOR(lambda me: lambda num_1: lambda num_2: GREATER_THAN_OR_EQUALS(num_1)(num_2)(lambda _: INC(me(SUBTRACT(num_1)(num_2))(num_2)))(lambda _: ZERO)(NONE))
MODULO = Z_COMBINATOR(lambda me: lambda num_1: lambda num_2: GREATER_THAN_OR_EQUALS(num_1)(num_2)(lambda _: me(SUBTRACT(num_1)(num_2))(num_2))(lambda _: num_1)(NONE))
FIBONACCI = Z_COMBINATOR(lambda me: lambda num: LESS_THAN_OR_EQUALS(num)(ONE)(lambda _: num)(lambda _: ADD(me(DEC(num)))(me(DEC(DEC(num)))))(NONE))
COUNT_PARTITIONS = Z_COMBINATOR(lambda me: lambda whole: lambda partition_max: IS_ZERO(whole)(lambda _: ONE)(IS_ZERO(partition_max)(lambda _: ZERO)(lambda _: ADD(LESS_THAN_OR_EQUALS(partition_max)(whole)(lambda _: me(SUBTRACT(whole)(partition_max))(partition_max))(lambda _: ZERO)(NONE))(me(whole)(DEC(partition_max)))))(NONE))
...
SUM = Z_COMBINATOR(lambda me: lambda linked_list: ADD(linked_list(ZERO))(linked_list(ONE)(lambda _: me(linked_list(TWO)))(lambda _: ZERO)(NONE)))
MAKE_LINKED_LIST_STUB = lambda element: MAKE_TRIPLET(element)(FALSE)(NONE)
PUSH_FRONT = lambda element: lambda linked_list: MAKE_TRIPLET(element)(TRUE)(linked_list)
PUSH_BACK = Z_COMBINATOR(lambda me: lambda linked_list: lambda element: linked_list(ONE)(lambda _: PUSH_FRONT(linked_list(ZERO))(me(linked_list(TWO))(element)))(lambda _: PUSH_FRONT(linked_list(ZERO))(MAKE_LINKED_LIST_STUB(element)))(NONE))
GET_ITEM = Z_COMBINATOR(lambda me: lambda linked_list: lambda index: IS_ZERO(index)(lambda _: linked_list(ZERO))(lambda _: me(linked_list(TWO))(DEC(index)))(NONE))
SET_ITEM = Z_COMBINATOR(lambda me: lambda linked_list: lambda index: lambda element: IS_ZERO(index)(lambda _: PUSH_FRONT(element)(linked_list(TWO)))(lambda _: PUSH_FRONT(linked_list(ZERO))(me(linked_list(TWO))(DEC(index))(element)))(NONE))
LEN = Z_COMBINATOR(lambda me: lambda linked_list: linked_list(ONE)(lambda _: INC(me(linked_list(TWO))))(lambda _: ONE)(NONE))
MAKE_LINKED_LIST_INTERNAL = Z_COMBINATOR(lambda me: lambda linked_list: lambda element: lambda expect_more_arguments: expect_more_arguments(lambda _: me(PUSH_BACK(linked_list)(element)))(lambda _: PUSH_BACK(linked_list)(element))(NONE))
...
TERM_COMBINE = Z_COMBINATOR(lambda me: lambda linked_list: lambda term: lambda combine_values: lambda start_value: combine_values(term(linked_list(ZERO)))(linked_list(ONE)(lambda _: me(linked_list(TWO))(term)(combine_values)(start_value))(lambda _: start_value)(NONE)))
TERM_SUM = lambda linked_list: lambda term: TERM_COMBINE(linked_list)(term)(ADD)(ZERO)
TERM_MAX = lambda linked_list: lambda term: TERM_COMBINE(linked_list)(term)(MAX)(ZERO)
TREE_TERM_SUM = Z_COMBINATOR(lambda me: lambda tree: lambda term: ADD(term(tree(ZERO)))(tree(ONE)(lambda _: TERM_SUM(tree(TWO))(lambda subtree: me(subtree)(term)))(lambda _: ZERO)(NONE)))
TREE_SUM = lambda tree: TREE_TERM_SUM(tree)(IDENTITY)
TREE_SIZE = lambda tree: TREE_TERM_SUM(tree)(lambda element: ONE)
TREE_VALID_COUNT = lambda tree: lambda element_condition: TREE_TERM_SUM(tree)(lambda element: element_condition(element)(ONE)(ZERO))
TREE_HAS_NUMERAL = lambda tree: lambda num: NOT(IS_ZERO(TREE_VALID_COUNT(tree)(lambda element: EQUALS(element)(num))))
DFS = Z_COMBINATOR(lambda me: lambda tree: lambda term: lambda combine_children_value_and_my_value: lambda default_children_value: lambda combine_child_values: lambda children_start_value: combine_children_value_and_my_value(term(tree))(tree(ONE)(lambda _: TERM_COMBINE(tree(TWO))(lambda subtree: me(subtree)(term)(combine_children_value_and_my_value)(default_children_value)(combine_child_values)(children_start_value))(combine_child_values)(children_start_value))(lambda _: default_children_value)(NONE)))
TREE_HEIGHT = lambda tree: DFS(tree)(lambda tree: ONE)(ADD)(ZERO)(MAX)(ZERO)

# check
my_linked_list = MAKE_TRIPLET(FIVE)(TRUE)(MAKE_TRIPLET(SEVEN)(TRUE)(MAKE_TRIPLET(TWO)(TRUE)(MAKE_TRIPLET(FOUR)(TRUE)(MAKE_TRIPLET(ONE)(TRUE)(MAKE_TRIPLET(TEN)(TRUE)(MAKE_TRIPLET(NINE)(FALSE)(NONE)))))))
...
my_little_tree = MAKE_TRIPLET(TWENTY)(TRUE)(MAKE_LINKED_LIST_STUB(MAKE_TRIPLET(FIVE)(FALSE)(NONE)))
my_big_tree = MAKE_TRIPLET(NINE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(FOUR)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ELEVEN)(FALSE)(NONE))(TRUE)(MAKE_TRIPLET(EIGHTEEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(NINETEEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ONE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TWO)(FALSE)(NONE))(TRUE)(MAKE_TRIPLET(TWENTY)(FALSE)(NONE))(TRUE)(MAKE_TRIPLET(TWENTY)(FALSE)(NONE))(TRUE)(MAKE_TRIPLET(TWENTY)(FALSE)(NONE))(TRUE)(MAKE_TRIPLET(FOUR)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(SIX)(FALSE)(NONE))(FALSE)))(TRUE)(MAKE_TRIPLET(ONE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(SEVEN)(FALSE)(NONE))(FALSE)))(FALSE)))(FALSE)))(FALSE)))(FALSE)))(TRUE)(MAKE_TRIPLET(THREE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(FOURTEEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(EIGHTEEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TWENTY)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ZERO)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TWELVE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ONE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TEN)(FALSE)(NONE))(FALSE)))(FALSE)))(FALSE)))(TRUE)(MAKE_TRIPLET(ONE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ELEVEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TWELVE)(FALSE)(NONE))(FALSE)))(FALSE)))(FALSE)))(TRUE)(MAKE_TRIPLET(TEN)(FALSE)(NONE))(FALSE)))(FALSE)))(TRUE)(MAKE_TRIPLET(SIXTEEN)(FALSE)(NONE))(FALSE)))(TRUE)(MAKE_TRIPLET(SEVEN)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(ZERO)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(TWO)(FALSE)(NONE))(FALSE)))(TRUE)(MAKE_TRIPLET(FIVE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(THREE)(TRUE)(MAKE_LINKED_LIST(MAKE_TRIPLET(THIRTEEN)(FALSE)(NONE))(FALSE)))(FALSE)))(FALSE)))(FALSE))
assert ZERO(lambda x: x+1)(0) == 0
assert SEVEN(lambda x: x+1)(0) == 7
assert TWENTY(lambda x: x+1)(0) == 20
assert IS_ZERO(ZERO)(True)(False)
assert not IS_ZERO(ONE)(True)(False)
